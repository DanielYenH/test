 ...
 * Tue Jan 04 2022 11:35:56 GMT+0800 (台北標準時間)
...
setHTMLElemStyle('minHeight', '11000px', ['BODY'], false);
...
eventHTMLElem('scroll', ['WINDOW'], false, function(event) {
  ...
  operateAnimation('SET_FRAME', getAnimations(['GROUP', 'DJN']), map_range(0, 8000, 0, 300, scroll_amount), null, 'AUTO', 1,
          function() {}, undefined, false);


  operateAnimation('SET_FRAME', 'Camera_static', map_range(0, 3000, 0, 300, scroll_amount), null, 'AUTO', 1,
          function() {}, undefined, false);


  operateAnimation('SET_FRAME', getAnimations('environment'), map_range(300, 8000, 0, 300, scroll_amount), null, 'AUTO', 1,
          function() {}, undefined, false);

      });

if (scroll_amount <= 3000) {
} else if (scroll_amount > 1000 && scroll_amount <= 2000) {

  operateAnimation('SET_FRAME', getAnimations(['GROUP', 'DJN']), Math.abs(map_range(1000, 2000, 0, 50, scroll_amount) - 50), null, 'AUTO', 1,
          function() {}, undefined, false);
